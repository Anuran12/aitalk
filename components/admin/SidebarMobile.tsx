        ...
        <div className="flex flex-col h-full items-center p-6 gap-10 relative">
          ...
          <div className="flex flex-col w-[80%] gap-8 items-center justify-center">
            <Link
              ...
              className="w-full flex gap-2 items-center hover:text-purple-600 transition-colors"
            >
              <svg
                width="18"
                height="18"
            ...
            <Link
              ...
              className="w-full flex gap-2 items-center text-[#787A7E] hover:text-purple-600 transition-colors"
            >
              <svg
                width="24"
                height="24"
